...
```javascript
// Import Io POC
window.Io=function(){this.tree=[]};Io.prototype.up=function(){var a=Object.create(this);this.tree.push(a);a.tree=[];return a};
...
```javascript
var testObj = new Io(),
  branch1 = testObj.up("testProp", "testValue1"),
  branch2 = testObj.up("testProp", "testValue2");
...
var root = new Io(),
  ...
  branch1 = root.up("testProp", "testValue"),
  branch2 = root.up("testProp", "testValue2"),
  branch21 = branch2.up({
    testProp: "testValue4",
    anotherProp: "ECMAScript ftw"
  });
...
// root.view === branch.view contains an Object without prototype [Object.create(null)]
